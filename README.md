...
Cygon Link is a Godot plugin that brings USDA (Universal Scene Description ASCII) assets exported from Cygon directly into the Godot editor. It parses scene hierarchies, meshes, and materials, and turns them into Godot `PackedScene` resources.
...
🛠️ **Pure GDScript, Zero Dependencies**: No native code, no third-party libraries, no OpenUSD compile step. Works on every platform Godot supports.
...
| [Requirements](Docs/Requirements.md)      | Software versions and platform support               |
| [Installation](Docs/Installation.md)      | Installing via the Godot Asset Store or a Git clone  |
| [First Import](Docs/FirstImport.md)       | Step-by-step guide for your first Cygon scene import |
| [Live Reimport](Docs/LiveSync.md)         | Keeping Godot in sync as you re-export from Cygon    |

## Getting Started

[//]: # (### Installation via the Godot Asset Store *&#40;soon&#41;*)
[//]: # (Once published, install it straight from the editor:)
[//]: # (1. Open the **AssetLib** tab in the Godot editor.)
[//]: # (2. Search for **Cygon Link**.)
[//]: # (3. Click **Download**, then **Install** into your project &#40;`addons/CygonLink/`&#41;.)
...
> **Note:** For further details on how to use the plugin and how to set up your project, see the [Getting Started Guide](Docs/GettingStarted.md).
...
## Miscellaneous
⚙️ **Requirements**
- Godot **4.6** or higher **(Earlier 4.x versions may work but are untested)**
- Cygon **0.3.3** or higher (earlier versions don't emit the export format the plugin expects)
